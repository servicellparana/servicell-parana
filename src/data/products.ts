export type ProductCategory = 'Celulares' | 'Smartwatch' | 'Fundas' | 'Audio' | 'Cargadores' | 'Protección'
...
const products: Product[] = [
  {
    ...
    category: 'Fundas',
    images: [publicAsset('assets/products/fundas-silicona-iphone-xr.png')],
  ...
  },
  {
    ...
    category: 'Cargadores',
    images: [
      publicAsset('assets/products/tars-20000mah-magsafe-01.png'),
      publicAsset('assets/products/tars-20000mah-magsafe-02.png'),
      publicAsset('assets/products/tars-20000mah-magsafe-03.png'),
      publicAsset('assets/products/tars-20000mah-magsafe-04.png'),
    ],
  ...
  {
    id: 13,
    slug: 'auriculares-xaea-crows',
    name: 'Auriculares XAEA Crows',
    category: 'Audio',
    images: [
      publicAsset('assets/products/xaea-crows-01.png'),
      publicAsset('assets/products/xaea-crows-02.png'),
      publicAsset('assets/products/xaea-crows-03.png'),
    ],
  ...
  {
    id: 12,
    slug: 'smartwatch-z66-ultra',
    name: 'Smartwatch Z66 Ultra',
    category: 'Smartwatch',
    images: [publicAsset('assets/products/smartwatch-z66-ultra-01.png')],
  ...
  {
    id: 11,
    slug: 'iphone-12-pro-128gb-bateria-100',
    name: 'iPhone 12 Pro 128GB',
    category: 'Celulares',
    images: [
      publicAsset('assets/products/iphone-12-pro-128gb-01.png'),
      publicAsset('assets/products/iphone-12-pro-128gb-02.png'),
      publicAsset('assets/products/iphone-12-pro-128gb-03.png'),
      publicAsset('assets/products/iphone-12-pro-128gb-04.png'),
      publicAsset('assets/products/iphone-12-pro-128gb-05.png'),
      publicAsset('assets/products/iphone-12-pro-128gb-06.png'),
      publicAsset('assets/products/iphone-12-pro-128gb-07.png'),
    ],
  ...
  {
    id: 9,
    slug: 'combo-cargador-iphone-20w',
    name: 'Combo cargador iPhone',
    category: 'Cargadores',
    images: [
      publicAsset('assets/products/combo-cargador-iphone.png'),
      publicAsset('assets/products/cargador-iphone-detalle.png'),
    ],
  ...
  },
  {
    ...
    category: 'Fundas',
    images: [publicAsset('assets/products/fundas-magsafe-iphone-13-v2.png')],
  ...
  {
    id: 7,
    slug: 'auriculares-aipods-06-dorados',
    name: 'Auriculares AiPods 06',
    category: 'Audio',
    images: [
      publicAsset('assets/products/aipods-06-pack.jpeg'),
      publicAsset('assets/products/aipods-06-dorado-detalle.png'),
      publicAsset('assets/products/aipods-06-negro.jpeg'),
    ],
  ...
  {
    id: 8,
    slug: 'auriculares-jbl-blancos',
    name: 'Auriculares JBL',
    category: 'Audio',
    images: [
      publicAsset('assets/products/jbl-blanco-frente.png'),
      publicAsset('assets/products/jbl-blanco-detalle.png'),
    ],
