...
const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Cargadores',
    images: [
      '/assets/products/tars-20000mah-magsafe-01.png',
      '/assets/products/tars-20000mah-magsafe-02.png',
      '/assets/products/tars-20000mah-magsafe-03.png',
      '/assets/products/tars-20000mah-magsafe-04.png',
    ],
  ...
  },
  {
    ...
    category: 'Audio',
    images: [
      '/assets/products/xaea-crows-01.png',
      '/assets/products/xaea-crows-02.png',
      '/assets/products/xaea-crows-03.png',
    ],
  ...
  },
  {
    ...
    category: 'Celulares',
    images: [
      '/assets/products/iphone-12-pro-128gb-01.png',
      '/assets/products/iphone-12-pro-128gb-02.png',
      '/assets/products/iphone-12-pro-128gb-03.png',
      '/assets/products/iphone-12-pro-128gb-04.png',
      '/assets/products/iphone-12-pro-128gb-05.png',
      '/assets/products/iphone-12-pro-128gb-06.png',
      '/assets/products/iphone-12-pro-128gb-07.png',
    ],
  ...
  },
  {
    ...
    category: 'Cargadores',
    images: [
      '/assets/products/combo-cargador-iphone.png',
      '/assets/products/cargador-iphone-detalle.png',
    ],
  ...
  },
  {
    ...
    badge: 'iPhone 13',
    featured: true,
    commentPrompt: 'Número de funda',
    commentPlaceholder: 'Ejemplo: 02',
    variants: [{ name: 'Modelo', options: ['iPhone 13'] }],
    specs: ['Diseño MagSafe', 'Modelo iPhone 13', 'Opciones numeradas en foto', 'Indicar 01, 02 o 03 en comentario'],
  },
  {
    id: 7,
    ...
    category: 'Audio',
    images: [
      '/assets/products/aipods-06-pack.jpeg',
      '/assets/products/aipods-06-dorado-detalle.png',
      '/assets/products/aipods-06-negro.jpeg',
    ],
  ...
  },
  {
    ...
    category: 'Audio',
    images: [
      '/assets/products/jbl-blanco-frente.png',
      '/assets/products/jbl-blanco-detalle.png',
    ],
